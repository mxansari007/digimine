        ...
        <div className="min-h-screen bg-slate-100 py-12 px-4">
            <div className="max-w-4xl mx-auto">
                ...
                {error ? (
                    ...
                    <Card className="p-12 text-center text-gray-500">No published quizzes yet.</Card>
                ) : (
                    <div className="grid gap-4">
                        {items.map((item) => {
                            const quizSlug = item.slug || item.id;
                                ...
                                <Card key={item.id} className="p-5 hover:shadow-md transition-shadow">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-4 ml-4">
                                            ...
                                            <Button variant="primary" size="sm" onClick={() => router.push(`/quizzes/${quizSlug}?${attemptQuery}`)}>Take Quiz</Button>
                                        </div>
                                    </div>
                                </Card>
                            );
