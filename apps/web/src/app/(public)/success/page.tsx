    ...
    useEffect(() => {
        ...
        async function verifyAndFetchOrder() {
            try {
                ...
                // If verifying strictly "just paid", the API returns the accessKey
                if (verifyData.success && verifyData.accessKey) {
                    // Auto-authorize because they JUST paid
                    await verifyAccessKey(verifyData.accessKey);
                    return;
                }
