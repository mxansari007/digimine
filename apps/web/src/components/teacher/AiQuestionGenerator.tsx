            ...
            <button
                ...
                className={`inline-flex items-center gap-1.5 rounded-xl border px-3.5 py-2 text-sm font-semibold transition-colors ${
                    disabled
                        ...
                        : "border-violet-300 bg-gradient-to-r from-violet-50 to-fuchsia-50 text-violet-700 hover:border-violet-400 hover:from-violet-100 hover:to-fuchsia-100"
                }`}
            >
    ...
    if (locked) {
        return (
            <Link
                ...
                className={
                    className ||
                    "inline-flex cursor-pointer items-center justify-center gap-1.5 rounded-xl border border-amber-300 bg-amber-50 px-3.5 py-2 text-sm font-semibold text-amber-700 hover:border-amber-400 hover:bg-amber-100"
                }
            >
