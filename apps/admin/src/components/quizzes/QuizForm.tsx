...
export function QuizForm({ initialData }: QuizFormProps) {
    ...
    const handleSubmit = async (event: FormEvent) => {
        ...
        try {
            ...
            if (initialData?.id) {
                await updateQuiz({ id: initialData.id, ...payload });
            } else {
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(event) => setFormData((prev) => ({ ...prev, status: event.target.value as QuizStatus }))}
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(event) => setFormData((prev) => ({ ...prev, accessType: event.target.value as QuizAccessType }))}
                                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 outline-none"
                            >
