...
export const PRODUCT_JSON_TEMPLATE = JSON.stringify(
    {
        ...
        description:
            "<p>A curated collection of the top 100 React interview questions, grouped by topic, with concise answers and code examples.</p><h2>What's inside</h2><ul><li>Hooks, lifecycle, performance</li><li>State management patterns</li><li>Testing and debugging tips</li></ul>",
