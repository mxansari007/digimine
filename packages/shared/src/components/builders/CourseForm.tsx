...
export interface CourseFormProps {
    ...
    /** Optional: course notes editor component. */
    CourseNotesEditor?: React.ComponentType<{
        chapters: CourseNoteChapter[];
        onChange: (chapters: CourseNoteChapter[]) => void;
        uploadPath?: string;
    }>;
    /**
     * Display mode. `teacher` hides status/pricing selectors because
...
export function CourseForm({ initialData, actingUserId, storage, onSubmit, loadTestSeries, loadQuizzes, CourseNotesEditor, mode = "admin" }: CourseFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {isTeacherMode && (
                <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
                    Course will be saved as <strong>private</strong> to your classroom. Submit it for review
                ...
                <aside className="space-y-6">
                    <Card padding="lg">
                        ...
                        <div className="space-y-4">
                            ...
                            {!isTeacherMode && formData.accessType === "enrollment_required" && (
